...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="{{ url('/blog-list') }}" class="h5 text-white">Trending Blogs</a>
                </div>
            </div>
        </div>
</div>
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="{{ $blog->blog_image_path }}" alt="">
                                    <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href="{{ url('/blogs', $blog->id) }}">{{ $blog->category_name }}</a>
                                </div>
                                <div class="p-4">
                                    ...
                                    <a class="text-uppercase" href="{{ url('/blogs', $blog->id) }}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        @foreach ($categories as $category)
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="{{ url('/blogs') }}"><i class="bi bi-arrow-right me-2"></i>{{ $category->name }}</a>
                        @endforeach
                        </div>
                    </div>
                    <!-- Category End -->
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex rounded overflow-hidden mb-3">
                            ...
                            <a href="{{ url('/blogs', $blog->id) }}" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">{{ $blog->name }}
                            </a>
                        </div>
                        @endforeach
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            @foreach ($tags as $tag)
                            <a href="{{ url('/blogs') }}" class="btn btn-light m-1">{{ $tag->name }}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="bg-light text-center" style="padding: 30px;">
                            ...
                            <a href="{{ url('/about') }}" class="btn btn-primary py-2 px-4">Read More</a>
                        </div>
                    </div>
                    <!-- Plain Text End -->
                </div>
