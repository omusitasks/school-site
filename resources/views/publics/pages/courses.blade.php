...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Courses</h1>
                    <a href="{{ url('/') }}" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{ url('/courses') }}" class="h5 text-white">Courses</a>
                </div>
            </div>
        </div>
</div>
                ...
                <div class="course-item bg-light">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                            ...
                            <a href="{{ url('/register') }}" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Web development</a>
                        </div>
                    </div>
