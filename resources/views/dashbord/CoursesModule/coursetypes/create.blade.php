...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Dashbord | Create Course Types</title>
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb ">
                                   ...
                                   <li class="breadcrumb-item active" aria-current="page">Create  Course Types</li>
                                </ol>
                             </nav>

                            <h4 class="mb-3">Create  Course Types</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <form action="{{ route('dashboard.coursetypes.store') }}" method="POST">
                        @csrf
