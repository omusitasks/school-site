                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard.users.index') }}" class="text-danger">User List</a></li>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="validationTooltip04" required="" name="role">
                                       ...
                                       @foreach ($role as $role)
                                          <option @if ($user->roles->isNotEmpty() && $user->roles->first()->name == $role->name) selected @endif value="{{ $role->name }}">{{ $role->name }}</option>
                                       @endforeach
                                    </select>
