...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Dashbord | All System Icons</title>
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb ">
                                   ...
                                   <li class="breadcrumb-item active" aria-current="page">Icons List</li>
                                </ol>
                             </nav>

                            <h4 class="mb-3">Icons List</h4>
                        </div>
                        @if (Auth::user()->hasPermissionTo('Tag create'))
                        <a href="{{ route('dashboard.icons.create') }}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Icons</a>
                        @endif
                    </div>
                </div>
                <div class="col-lg-12">
                    ...
                    <div class="d-flex align-items-center list-action">
                        @auth
                            @if (Auth::user()->hasRole('admin'))
                                <a href="{{ route('dashboard.icons.show', $ic->id) }}" class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="View"><i class="ri-eye-line mr-0"></i></a>
                                <a href="{{ route('dashboard.icons.edit', $ic->id) }}" class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Edit"><i class="ri-pencil-line mr-0"></i></a>
                                
                                
                                <form id="deleteCourseForm{{ $ic->id }}" action="{{ route('dashboard.icons.destroy', $ic->id) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
