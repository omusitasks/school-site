...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Dashbord | Social Media</title>
                ...
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            ...
                            <h4 class="mb-3">Social Media List</h4>
                        </div>
                        @if (Auth::user()->hasPermissionTo('Tag create'))
                        <a href="{{ route('dashboard.social_media.create') }}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Social Media</a>
                        @endif
                    </div>
                </div>
                <div class="col-lg-12">
                    ...
                    <div class="d-flex align-items-center list-action">
                        @auth
                            @if (Auth::user()->hasRole('admin'))
                                <a href="{{ route('dashboard.social_media.show', $ic->id) }}" class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="View"><i class="ri-eye-line mr-0"></i></a>
                                <a href="{{ route('dashboard.social_media.edit', $ic->id) }}" class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Edit"><i class="ri-pencil-line mr-0"></i></a>
                                

                                <form id="deleteCourseForm{{ $ic->id }}" action="{{ route('dashboard.social_media.destroy', $ic->id) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
