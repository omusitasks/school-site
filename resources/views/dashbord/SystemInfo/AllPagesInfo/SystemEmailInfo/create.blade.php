...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Dashbord | Create Email Information</title>
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb ">
                                   ...
                                   <li class="breadcrumb-item active" aria-current="page">Create Email Information</li>
                                </ol>
                             </nav>

                            <h4 class="mb-3">Create Email Information</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <form action="{{ route('dashboard.email_information.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputText">Company Email</label>
                           <input type="text" class="form-control" id="exampleInputText" name="company_email">
