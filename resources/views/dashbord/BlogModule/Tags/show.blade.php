...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Dashbord | Tag Detail View</title>
        ...
        <div class="container-fluid">
            <div class="container-fluid">
               ...
               <div class="row d-flex justify-content-start bg-light rounded">
                  ...
                  <div>
                  <p>Created By | {{ $tag->author }} | {{ $duration }}</p>
                  <!-- <p>Created On | {{ $tag->created_at }}</p> -->
                  </div>
                  <div>
                  <p>Updated On | 
                  @if ($tag->updated_at)
                  ...
                  <div class="col-lg-2  pt-3 mb-1">
                      <div class="d-flex align-items-center m-0 list-action">
                          <a href="{{ route('dashboard.tags.edit',$tag->id) }}" class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" ><i class="ri-pencil-line mr-0"></i></a>
                   ...
                   <div class="card bg-white">
                      <div class="card-body">
                         ...
                         <blockquote class="blockquote mb-0">
                            <footer class="blockquote-footer font-size-15">{{ $tag->name }} <cite title="Source Title" class="text-white"></cite></footer>
                         </blockquote>
                      </div>
                   </div>
                </div>
               ...
               <div class="col-lg-8 col-md-12 col-sm-12">
                   <div class="card bg-white">
                      <div class="card-body">
                         ...
                         <blockquote class="blockquote mb-0">
                            <footer class="blockquote-footer font-size-15">{{ $tag->description }} <cite title="Source Title" class="text-white"></cite></footer>
                         </blockquote>
                      </div>
                   </div>
                </div>
